...
class PaymentReceivedUserMail extends Mailable
{
    ...
    {
        $this->email_message = EmailMessage::where('ref', 'payment-received.user')->first();
        ...
        return $this->subject($this->email_message->subject)
            ->markdown('emails.payment-received-user');
    }
}
