...
return [
    ...
    */
    ...
    'valid_voucher'        => 'O voucher indicado já expirou.',
    ...
    */
    ...
    'attributes'           => [
        ...
        'billing_country_id' => "país (faturação)",
        'billing_name' => "nome (faturação)",
        'billing_phone' => "contacto (faturação)",
        'billing_zip_code' => "código postal (faturação)",
        'email' => "e-mail",
        'message' => "mensagem",
        'name' => "nome",
        ...
        'shipping_city' => "localidade (envio)",
        'shipping_country_id' => "país (envio)",
        'shipping_method_id' => "método de envio",
        'shipping_name' => "nome (envio)",
        'shipping_phone' => "contacto (envio)",
        'shipping_zip_code' => "código postal (envio)",
        'subject' => "assunto",
        'vat_number' => "NIF",
    ],
